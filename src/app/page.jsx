...
// We are hiding this for a moment to see if the project deploys
...
export default function Home() {
  return (
    <main className="min-h-screen bg-brand-charcoal flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl px-4 md:px-8 py-12 flex flex-col h-screen text-center">
        ...
        <div className="flex-1 flex flex-col justify-center w-full">
            ...
            <p className="text-brand-bone-dark font-sans text-xs tracking-[0.2em] uppercase mt-4">
